...
@Sliced
public class ShortMatter extends RawMatter<Short> {
    public ShortMatter() {
        this(1, 1, 1);
    }
    ...
    @Override
    public void writeNode(Short b, DataOutputStream dos) throws IOException {
        dos.writeShort(b);
    }

    @Override
    public Short readNode(DataInputStream din) throws IOException {
